...
def advanced_options_func():
    ...
    if (adOp):
        ...
        pi = tk.Button(form, text="π", command=lambda: writer(pi), font="Arial 10 bold")
        pi.place(relx=0.12, rely=0.88, relwidth=0.16, relheight=0.10)

        us = tk.Button(form, text="^", command=lambda: writer(us), font="Verdana 10 bold")
        us.place(relx=0.32, rely=0.88, relwidth=0.16, relheight=0.10)

        kl = tk.Button(form, text="%", command=lambda: writer(kl), font="Verdana 10 bold")
        kl.place(relx=0.52, rely=0.88, relwidth=0.16, relheight=0.10)

        kr = tk.Button(form, text="√()", command=lambda: writer(kr), font="Verdana 10 bold")
...
to = tk.Button(form, text="+", command=lambda: writer(to), font="Verdana 10 bold", bg="white")
ci = tk.Button(form, text="-", command=lambda: writer(ci), font="Verdana 10 bold", bg="white")
ca = tk.Button(form, text="*", command=lambda: writer(ca), font="Verdana 10 bold", bg="white")
bo = tk.Button(form, text="/", command=lambda: writer(bo), font="Verdana 10 bold", bg="white")

n1 = tk.Button(form, text="1", command=lambda: writer(n1), font="Verdana 10 bold", bg="white")
n2 = tk.Button(form, text="2", command=lambda: writer(n2), font="Verdana 10 bold", bg="white")
n3 = tk.Button(form, text="3", command=lambda: writer(n3), font="Verdana 10 bold", bg="white")

n4 = tk.Button(form, text="4", command=lambda: writer(n4), font="Verdana 10 bold", bg="white")
n5 = tk.Button(form, text="5", command=lambda: writer(n5), font="Verdana 10 bold", bg="white")
n6 = tk.Button(form, text="6", command=lambda: writer(n6), font="Verdana 10 bold", bg="white")

n7 = tk.Button(form, text="7", command=lambda: writer(n7), font="Verdana 10 bold", bg="white")
n8 = tk.Button(form, text="8", command=lambda: writer(n8), font="Verdana 10 bold", bg="white")
n9 = tk.Button(form, text="9", command=lambda: writer(n9), font="Verdana 10 bold", bg="white")

si = tk.Button(form, text="C", command=clear_func, font="Verdana 10 bold", bg="white")
n0 = tk.Button(form, text="0", command=lambda: writer(n0), font="Verdana 10 bold", bg="white")

no = tk.Button(form, text=".", command=lambda: writer(no), font="Verdana 10 bold", bg="white")
de = tk.Button(form, text="Del", command=deleter, font="Verdana 10 bold", bg="white")

p1 = tk.Button(form, text="(", command=lambda: writer(p1), font="Verdana 10 bold", bg="white")
p2 = tk.Button(form, text=")", command=lambda: writer(p2), font="Verdana 10 bold", bg="white")

en = tk.Button(form, text="=", command=calc_func, font="Verdana 10 bold", bg="white")


adop_but = tk.Button(form, text="Show Advanced Options", command=advanced_options_func, font="Verdana 10 bold", bg="white")
